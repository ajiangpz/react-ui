...
import { _ as _asyncToGenerator, a as _regeneratorRuntime } from '../../_chunks/dep-DUWadCCb.js';
...
function useInstance(props, formRef, formMapRef, floatingFormDataRef) {
  ...
  function _validate() {
    _validate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee(param) {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              ...
              return isFunction(formItemRef === null || formItemRef === void 0 || (_formItemRef$current15 = formItemRef.current) === null || _formItemRef$current15 === void 0 ? void 0 : _formItemRef$current15.validate) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current16 = formItemRef.current) === null || _formItemRef$current16 === void 0 ? void 0 : _formItemRef$current16.name, fields);
            }).map(function (formItemRef) {
              var _formItemRef$current17, _formItemRef$current18;
              return formItemRef === null || formItemRef === void 0 || (_formItemRef$current17 = formItemRef.current) === null || _formItemRef$current17 === void 0 || (_formItemRef$current18 = _formItemRef$current17.validate) === null || _formItemRef$current18 === void 0 ? void 0 : _formItemRef$current18.call(_formItemRef$current17, trigger, showErrorMessage);
            });
            _context.next = 1;
  ...
  function _validateOnly() {
    _validateOnly = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee2(param) {
      ...
      return _regeneratorRuntime.wrap(function (_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
              var _formItemRef$current19, _formItemRef$current20;
              return isFunction(formItemRef === null || formItemRef === void 0 || (_formItemRef$current19 = formItemRef.current) === null || _formItemRef$current19 === void 0 ? void 0 : _formItemRef$current19.validateOnly) && needValidate(formItemRef === null || formItemRef === void 0 || (_formItemRef$current20 = formItemRef.current) === null || _formItemRef$current20 === void 0 ? void 0 : _formItemRef$current20.name, fields);
            }).map(function (formItemRef) {
              var _formItemRef$current21, _formItemRef$current22;
              return formItemRef === null || formItemRef === void 0 || (_formItemRef$current21 = formItemRef.current) === null || _formItemRef$current21 === void 0 || (_formItemRef$current22 = _formItemRef$current21.validateOnly) === null || _formItemRef$current22 === void 0 ? void 0 : _formItemRef$current22.call(_formItemRef$current21, trigger);
            });
            _context2.next = 1;
            return Promise.all(list);
          case 1:
    ...
    if (nameList === true) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var fieldValue = null;
          var currentRef = formItemRef;
          if (currentRef !== null && currentRef !== void 0 && (_currentRef$current = currentRef.current) !== null && _currentRef$current !== void 0 && _currentRef$current.isFormList) {
            var _currentRef$current2, _currentRef$current2$;
            fieldValue = calcFieldValue(name, currentRef === null || currentRef === void 0 || (_currentRef$current2 = currentRef.current) === null || _currentRef$current2 === void 0 || (_currentRef$current2$ = _currentRef$current2.getValue) === null || _currentRef$current2$ === void 0 ? void 0 : _currentRef$current2$.call(_currentRef$current2));
          } else {
            var _currentRef$current3, _currentRef$current3$;
            fieldValue = calcFieldValue(name, currentRef === null || currentRef === void 0 || (_currentRef$current3 = currentRef.current) === null || _currentRef$current3 === void 0 || (_currentRef$current3$ = _currentRef$current3.getValue) === null || _currentRef$current3$ === void 0 ? void 0 : _currentRef$current3$.call(_currentRef$current3), !props.supportNumberKey);
          }
      ...
      nameList.forEach(function (name) {
        ...
        var fieldValue = calcFieldValue(name, formItemRef === null || formItemRef === void 0 || (_formItemRef$current$2 = (_formItemRef$current2 = formItemRef.current).getValue) === null || _formItemRef$current$2 === void 0 ? void 0 : _formItemRef$current$2.call(_formItemRef$current2));
        merge(fieldsValue, fieldValue);
      });
    }
    return fieldsValue;
  ...
  function setFields() {
    ...
    fields.forEach(function (field) {
      ...
      var formItemRef = getMapValue(name, formMapRef);
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current3 = formItemRef.current) === null || _formItemRef$current3 === void 0 || _formItemRef$current3.setField(restFields, field);
    });
  }
  function reset(params) {
    if (typeof params === "undefined") {
      _toConsumableArray(formMapRef.current.values()).forEach(function (formItemRef) {
        ...
        formItemRef === null || formItemRef === void 0 || (_formItemRef$current4 = formItemRef.current) === null || _formItemRef$current4 === void 0 || (_formItemRef$current5 = _formItemRef$current4.resetField) === null || _formItemRef$current5 === void 0 || _formItemRef$current5.call(_formItemRef$current4);
      });
    } else {
      ...
      fields.forEach(function (name) {
        ...
        var formItemRef = getMapValue(name, formMapRef);
        formItemRef === null || formItemRef === void 0 || (_formItemRef$current6 = formItemRef.current) === null || _formItemRef$current6 === void 0 || _formItemRef$current6.resetField(type);
      });
    }
  ...
  function setValidateMessage(message) {
    travelMapFromObject(message, formMapRef, function (formItemRef, fieldValue) {
      var _formItemRef$current9, _formItemRef$current0;
      formItemRef === null || formItemRef === void 0 || (_formItemRef$current9 = formItemRef.current) === null || _formItemRef$current9 === void 0 || (_formItemRef$current0 = _formItemRef$current9.setValidateMessage) === null || _formItemRef$current0 === void 0 || _formItemRef$current0.call(_formItemRef$current9, fieldValue);
    });
  }
  function getValidateMessage(fields) {
    ...
    if (typeof fields === "undefined") {
      _toConsumableArray(formMapRef.current.values()).forEach(function (formItemRef) {
        var _formItemRef$current1, _formItemRef$current10, _formItemRef$current11;
        var item = formItemRef === null || formItemRef === void 0 || (_formItemRef$current1 = formItemRef.current) === null || _formItemRef$current1 === void 0 || (_formItemRef$current10 = _formItemRef$current1.getValidateMessage) === null || _formItemRef$current10 === void 0 ? void 0 : _formItemRef$current10.call(_formItemRef$current1);
        if (isEmpty(item)) return;
        message[String(formItemRef === null || formItemRef === void 0 || (_formItemRef$current11 = formItemRef.current) === null || _formItemRef$current11 === void 0 ? void 0 : _formItemRef$current11.name)] = item;
      });
    } else {
      if (!Array.isArray(fields)) throw new Error("getValidateMessage \u53C2\u6570\u9700\u8981 Array \u7C7B\u578B");
      fields.forEach(function (name) {
        var _formItemRef$current12, _formItemRef$current13, _formItemRef$current14;
        var formItemRef = getMapValue(name, formMapRef);
        var item = formItemRef === null || formItemRef === void 0 || (_formItemRef$current12 = formItemRef.current) === null || _formItemRef$current12 === void 0 || (_formItemRef$current13 = _formItemRef$current12.getValidateMessage) === null || _formItemRef$current13 === void 0 ? void 0 : _formItemRef$current13.call(_formItemRef$current12);
        if (isEmpty(item)) return;
        message[String(formItemRef === null || formItemRef === void 0 || (_formItemRef$current14 = formItemRef.current) === null || _formItemRef$current14 === void 0 ? void 0 : _formItemRef$current14.name)] = item;
      });
    }
