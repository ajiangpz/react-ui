...
import { g as getValueToOption, a as getSelectValueArr, b as getSelectedOptions, P as PopupContent } from '../_chunks/dep-GP5EdKxc.js';
...
import { O as OptionGroup, s as selectDefaultProps } from '../_chunks/dep-DhCjmfsm.js';
import { Tag } from '../tag/index.js';
import { _ as _typeof } from '../_chunks/dep-D-UKOauR.js';
import { c as composeRefs } from '../_chunks/dep-C1XcmShP.js';
import { a as parseContentTNode } from '../_chunks/dep-aX8qrQpB.js';
      ...
      var _handlerOptionElement = function handlerOptionElement(v) {
        if (/*#__PURE__*/React.isValidElement(v)) {
          if (v.type === OptionGroup) {
            var children2 = v.props.children;
            var childrenArray = Array.isArray(children2) ? children2 : children2 ? [children2] : [];
            return _objectSpread$1(_objectSpread$1({}, v.props), {}, {
              group: v.props.label,
              children: childrenArray.map(function (v2) {
  ...
  useEffect(function () {
    ...
    setSelectedOptions(function (oldSelectedOptions) {
      var createOptionFromValue = function createOptionFromValue(item) {
        ...
        return _defineProperty(_defineProperty({}, valueKey, item), labelKey, item);
      };
      if (Array.isArray(value)) {
        return value.map(createOptionFromValue).filter(function (opt) {
          return opt !== null && opt !== void 0;
        });
      }
