...
import { getAttach } from '../common/Portal.js';
...
var createDialog = function createDialog(props) {
  ...
  var attachResult = getAttach(options.attach);
  var container = (attachResult && attachResult instanceof HTMLElement ? attachResult : null) || document.body;
  if (container) {
