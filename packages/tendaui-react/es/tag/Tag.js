...
import { X } from '../_chunks/dep-LgDsOUkE.js';
...
var TagFunction = function TagFunction(originalProps, ref) {
  ...
  var tag = /*#__PURE__*/React.createElement("div", _extends({
    ref: ref,
    ...
    style: getTagStyle
  }, otherTagProps), /*#__PURE__*/React.createElement(React.Fragment, null, icon, /*#__PURE__*/React.createElement("span", _extends({
    className: maxWidth ? "".concat(tagClassPrefix, "--text") : undefined,
    style: getTextStyle
