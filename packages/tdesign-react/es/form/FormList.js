...
import { H as HOOK_MARK } from '../_chunks/dep-CcL4GSfv.js';
...
var FormList = function FormList(props) {
  ...
  var _useState = reactExports.useState(initialData),
  ...
  var formListMapRef = reactExports.useRef(/* @__PURE__ */new Map());
  var formListRef = reactExports.useRef(null);
  var fieldsTaskQueueRef = reactExports.useRef([]);
  ...
  reactExports.useImperativeHandle(formListRef, function () {
    return {
      name: name,
      isFormList: true,
