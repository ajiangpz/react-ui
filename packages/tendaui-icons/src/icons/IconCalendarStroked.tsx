    ...
    return (
        ...
        >
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M9.65 2.11a1.11 1.11 0 1 0-2.22 0v.87H3.1A2.1 2.1 0 0 0 1 5.08V20.9c0 1.16.94 2.1 2.1 2.1h17.8a2.1 2.1 0 0 0 2.1-2.1V5.08a2.1 2.1 0 0 0-2.1-2.1h-4.33V2.1a1.11 1.11 0 1 0-2.22 0v.87h-4.7zm6.92 18.67h4.2v-3.71h-4.2zm0-5.94h4.2v-3.7h-4.2zm-2.22-3.7v3.7h-4.7v-3.7zm1.11-2.23h5.32v-3.7h-4.2v.86a1.11 1.11 0 1 1-2.23 0V5.2h-4.7v.87a1.11 1.11 0 0 1-2.22 0V5.2h-4.2v3.71h12.23m-1.11 8.16v3.7h-4.7v-3.7zm-6.92 3.7v-3.7h-4.2v3.7zm0-5.93v-3.7h-4.2v3.7z"
                fill="currentColor"
            />
        </svg>
    );
