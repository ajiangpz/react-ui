...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            />
            <path
                d="M19.43 19.59c0 .97.51 1.51 1.43 1.51s1.42-.54 1.42-1.52v-6.27c0-1.04-.66-1.7-1.67-1.7-.57 0-1.2.18-1.79.54l-.96.58q-.73.44-.73 1.06c0 .57.4.96.96.96.28 0 .5-.08.95-.35l.38-.22h.01z"
                fill="currentColor"
            />
        </svg>
    );
